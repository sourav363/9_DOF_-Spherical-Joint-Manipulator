classdef SphericalJointManp_app < matlab.apps.AppBase
...
%                 patch(app.UIAxes,act_pos(1,1:3),act_pos(2,1:3),act_pos(3,1:3),[1 1 0]);
%                 patch(app.UIAxes,act_pos(1,2:4),act_pos(2,2:4),act_pos(3,2:4),[0 0 1]);
                drawnow;             
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            ylabel(app.UIAxes, 'Y')
            zlabel(app.UIAxes, 'Z')
            app.UIAxes.Color = [0.651 0.651 0.651];
            app.UIAxes.XGrid = 'on';
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = SphericalJointManp_app
